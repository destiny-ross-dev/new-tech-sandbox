  ...
  render() {
    return (
      <div style={{ display: "inline-block", position: "relative" }}>
        ...
        >
          <strong>Title</strong>{" "}
          {this.state.hovered && this.state.hovered.data.title}
          <br />
          <strong>Date</strong>{" "}
          {this.state.hovered &&
            d3.timeFormat("%b %d, %Y")(this.state.hovered.data.date)}
          <br />
          <strong>Metascore</strong>{" "}
          {this.state.hovered && this.state.hovered.data.score}
          <br />
          <strong>Box office</strong>{" "}
          {this.state.hovered &&
            d3.format("$,.0f")(this.state.hovered.data.boxOffice)}
          <br />
        </div>
      </div>
    );
